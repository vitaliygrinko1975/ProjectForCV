            ...
            <tr>
                ...
                <td>
                    <form method="post" action="makeOrder">
                        ...
                        <button type="submit" name="makeOrderById" value="${car.id}"
                                class="btn btn-primary btn-block btn-large">make an orders
                        </button>
                    </form>
                </td>
            </tr>
    ...
    <div align='center'>
        <div style="display: inline-block; padding-right: 50px;">
            <form method='post' action="selectByClass">
                ...
                <button type='submit' name='Butt' value='0' class='btn btn-primary btn-block btn-large'>
                    ENTER
                </button>
            </form>
        </div>
